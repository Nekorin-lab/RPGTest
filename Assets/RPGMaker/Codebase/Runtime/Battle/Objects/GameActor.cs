    ...
    public class GameActor : GameBattler
    {
        ...
        public List<SkillCustomDataModel> Skills() {
            ...
            foreach (var id in Actor.skills)
            {
                ...
                if (!list.Contains(skillData)) list.Add(skillData);
            }
        ...
        public List<string> EquipSlots() {
            ...
            if (slots.Count >= 2 && IsDualWield()) slots[1] = "48254f68-178f-448e-98fd-60a0bb616a28";
        ...
        /// <param name="item"></param>
        /// <returns></returns>
        public bool TestEscape(GameItem item) {
            if (item.Effects == null)
                return false;

            return item.Effects.Any(effect => effect != null && effect.effectId == GameAction.EffectSpecial);
        }
