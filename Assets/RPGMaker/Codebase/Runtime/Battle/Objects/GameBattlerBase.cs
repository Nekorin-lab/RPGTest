...
namespace RPGMaker.Codebase.Runtime.Battle.Objects
{
    ...
    public class GameBattlerBase
    {
        ...
        public virtual bool CanEquipWeapon(GameItem item) {
            return true; //IsEquipWtypeOk(item.WTypeId) && !IsEquipTypeSealed(item.ETypeId);
        }
        ...
        public virtual bool CanEquipArmor(GameItem item) {
            return true; //IsEquipAtypeOk(item.ATypeId) && !IsEquipTypeSealed(item.ETypeId);
        }
        ...
        public virtual bool CanAttack() {
            return CanUse(new GameItem(AttackSkillId, GameItem.DataClassEnum.Skill));
        }
