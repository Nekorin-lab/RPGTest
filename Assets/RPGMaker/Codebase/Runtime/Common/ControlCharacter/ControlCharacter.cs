            ...
            private void ExecParseChar(
                ...
                do
                {
                        ...
                        case '\\':
                        {
                            ...
                            switch (match.Groups["Name"].Value)
                            {
                                ...
                                case "N":
                                {
                                    ...
                                    text = text.Insert(charIndex, characterActor?.basic.name ?? "?");
                                    break;
                                }
                                ...
                                case "P":
                                {
                                    ...
                                    {
                                        var actor = DataManager.Self()
                                            .GetActorDataModel(partyMemberIds[partyMenberIndex]);
                                        s = actor.basic.name;
                                    }
                                ...
                                // [動作系] \f 改ページをします (バトルの場合のみ)。Uniteで追加されたもの？
                                case "f":
                                {
                    ...
                    static int GetParam(Match match) {
                        return int.Parse(match.Groups["Param"].Value);
                    }
