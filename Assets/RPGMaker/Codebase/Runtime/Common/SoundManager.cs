...
namespace RPGMaker.Codebase.Runtime.Common
{
    public class SoundManager : MonoBehaviour
    {
        ...
        public async Task PlayBgm() {
            ...
            await Task.Delay(1);
            _bgmClip.volume = _bgmSoundCommon.volume / 100f * _runtimeConfigDataModel.bgmVolume / 100f;
        ...
        public async Task PlayBgs() {
            ...
            _bgsClip.volume = _bgsSoundCommon.volume / 100f * _runtimeConfigDataModel.bgsVolume / 100f;
        ...
        public async Task PlayMe() {
            ...
            _meClip.volume = _meSoundCommon.volume / 100f * _runtimeConfigDataModel.meVolume / 100f;
        ...
        public async void PlaySe() {
            ...
            audioSource.volume = _seSoundCommon.volume / 100f * _runtimeConfigDataModel.seVolume / 100f;
