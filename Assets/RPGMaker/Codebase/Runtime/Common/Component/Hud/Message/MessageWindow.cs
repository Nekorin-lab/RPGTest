...
namespace RPGMaker.Codebase.Runtime.Common.Component.Hud.Message
{
    public class MessageWindow : MonoBehaviour
    {
        ...
        public void ShowName(string actorName) {
            ...
            // _name.font = Font.CreateDynamicFontFromOSFont(
            //     _uiSettingDataModel.talkMenu.characterMenu.nameFontSetting.font,
            //     _uiSettingDataModel.talkMenu.characterMenu.nameFontSetting.size
            // );
            var nameFont = _uiSettingDataModel.talkMenu.characterMenu.nameFontSetting;
            var uniteFontResize = new FontSize(nameFont.size);
