...
namespace RPGMaker.Codebase.Runtime.Common.Component.Hud.Character
{
    public class MovePlace : MonoBehaviour
    {
        ...
        private async void ReflectionBgmBgs(MapDataModel nextMap) {
            ...
            {
                //データの作成
                var sound = new SoundCommonDataModel(nextMap.bgmID, nextMap.bgmState.pan, nextMap.bgmState.pitch,
                    nextMap.bgmState.volume);
            ...
            {
                //データの作成
                var sound = new SoundCommonDataModel(nextMap.bgsID, nextMap.bgsState.pan, nextMap.bgsState.pitch,
                    nextMap.bgsState.volume);
                SoundManager.Self().Init();
                //データのセット
