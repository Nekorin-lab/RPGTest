...
namespace RPGMaker.Codebase.Runtime.Common
{
    public static class InputHandler
    {
        ...
        public static void Watch() {
            ...
            // ダッシュ用
            if (_currentInputSystemState.CurrentInputSystemState(HandleType.LeftShiftDown))
            {
                Handle(HandleType.LeftShiftDown);
            }
            if (_currentInputSystemState.CurrentInputSystemState(HandleType.LeftShiftUp))
            {
                Handle(HandleType.LeftShiftUp);
            }
