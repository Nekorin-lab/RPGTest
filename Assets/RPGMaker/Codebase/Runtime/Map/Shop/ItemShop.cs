    ...
    public class ItemShop : WindowBase
    {
        ...
        private void SetupBelongingList() {
            ...
            contentParent[1].GetComponent<RectTransform>().sizeDelta =
                new Vector2(contentParent[1].GetComponent<RectTransform>().sizeDelta.x, (_belongingDic[ItemShopContent.Type.ITEM].Count % 2) * 70);
            contentParent[2].GetComponent<RectTransform>().sizeDelta =
                new Vector2(contentParent[2].GetComponent<RectTransform>().sizeDelta.x, (_belongingDic[ItemShopContent.Type.WEAPON].Count % 2) * 70);
            contentParent[3].GetComponent<RectTransform>().sizeDelta =
                new Vector2(contentParent[3].GetComponent<RectTransform>().sizeDelta.x, (_belongingDic[ItemShopContent.Type.ARMOR].Count % 2) * 70);
            contentParent[4].GetComponent<RectTransform>().sizeDelta =
                new Vector2(contentParent[4].GetComponent<RectTransform>().sizeDelta.x, (_belongingDic[ItemShopContent.Type.IMPORTANT].Count % 2) * 70);
        ...
        private void changeEnabledButton() {
            //Debug.Log("changeEnabledButton processingKind == " + _processingKind);
