...
{
    public class WeaponGraphic : CharacterGraphic
    {
        ...
        protected override void SetUpSprites(string assetId) {
            if (assetId != "")
            {
                ...
                // アニメーション速度
                var spriteSpeed = assetManageData.imageSettings[0].animationSpeed == 0 ? 1 : assetManageData.imageSettings[0].animationSpeed;
        ...
        protected override Sprite LoadCharacterSprite(string fileName) {
            ...
            return UnityEditorWrapper.AssetDatabaseWrapper.LoadAssetAtPath<Sprite>(
                "Assets/RPGMaker/Storage/Images/System/Weapon/" + fileName);
        }
