            ...
            for (int i = 0; i < _tilemaps.Count; i++)
            {
                ...
                if (i == (int) MapDataModel.Layer.LayerType.Shadow)
                {
                    for (var x = _xPosMin * 2 - 2; x <= _xPosMax * 2 + 2; ++x)
                    {
                        ...
                        MoveTile(tilemap, new Vector3Int(x, _yPosMax * 2 + 1, 0), new Vector3Int(x, _yPosMin * 2 + 3, 0));
                    }
                }
                else
                {
        ...
        public void MapLoopDown(CharacterOnMap actorMap) {
            ...
            for (int i = 0; i < _tilemaps.Count; i++)
            {
                ...
                if (i == (int) MapDataModel.Layer.LayerType.Shadow)
                {
                    for (var x = _xPosMin * 2 - 2; x <= _xPosMax * 2 + 2; ++x)
                    {
                        MoveTile(tilemap, new Vector3Int(x, _yPosMin * 2 + 1, 0), new Vector3Int(x, _yPosMax * 2 - 1, 0));
            ...
            for (int i = 0; i < _tilemaps.Count; i++)
            {
                ...
                if (i == (int) MapDataModel.Layer.LayerType.Shadow)
                {
                    for (var y = _yPosMax * 2 - 2; y <= _yPosMin * 2 + 2; y++)
                    {
                        ...
                        MoveTile(tilemap, new Vector3Int(_xPosMin * 2 + 1, y, 0), new Vector3Int(_xPosMax * 2 + 3, y, 0));
                    }
                }
                else
                {
        ...
        public void MapLoopLeft(CharacterOnMap actorMap) {
            ...
            for (int i = 0; i < _tilemaps.Count; i++)
            {
                ...
                if (i == (int) MapDataModel.Layer.LayerType.Shadow)
                {
                    for (var y = _yPosMax * 2 - 2; y <= _yPosMin * 2 + 2; y++)
                    {
                        MoveTile(tilemap, new Vector3Int(_xPosMax * 2 + 1, y, 0), new Vector3Int(_xPosMin * 2 - 1, y, 0));
