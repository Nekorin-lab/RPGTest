...
namespace RPGMaker.Codebase.CoreSystem.Service.MapManagement
{
    public class MapManagementService
    {
        ...
        private List<MapDataModel.Layer> CreateMapLayers(GameObject prefabRoot) {
            ...
            layers.Insert(
                ...
                new MapDataModel.Layer(
                    ...
                    new List<TileDataModel>()));

            layers.Insert(
                MapDataModel.GetLayerIndexByType(MapDataModel.Layer.LayerType.A),
                new MapDataModel.Layer(MapDataModel.Layer.LayerType.A, new Tilemap(), new List<TileDataModel>()));
            layers.Insert(
            ...
            layers.Insert(
                ...
                new MapDataModel.Layer(MapDataModel.Layer.LayerType.B, new Tilemap(), new List<TileDataModel>()));
            layers.Insert(
                ...
                new MapDataModel.Layer(MapDataModel.Layer.LayerType.B_Effect, new Tilemap(),
                    new List<TileDataModel>()));
            // new MapDataModel.Layer(MapDataModel.Layer.LayerType.Shadow, new Grid(),
            // new Vector2(0.5f,0.5f), new Tilemap(), _shadowTileRepository.GetShadowTileDataModel()),
            layers.Insert(
                MapDataModel.GetLayerIndexByType(MapDataModel.Layer.LayerType.Shadow),
                new MapDataModel.Layer(MapDataModel.Layer.LayerType.Shadow, new Tilemap(), new List<TileDataModel>()));
            layers.Insert(
                MapDataModel.GetLayerIndexByType(MapDataModel.Layer.LayerType.C),
                new MapDataModel.Layer(MapDataModel.Layer.LayerType.C, new Tilemap(), new List<TileDataModel>()));
            layers.Insert(
            ...
            layers.Insert(
                ...
                new MapDataModel.Layer(MapDataModel.Layer.LayerType.D, new Tilemap(), new List<TileDataModel>()));
            layers.Insert(
            ...
            foreach (var layer in layers)
            {
                ...
                tilemapContainer.transform.parent = prefabRoot.transform;
                ...
                layer.tilesOnPalette = new List<TileDataModel>();
            }
        ...
        // タイル操作
        //--------------------------------------------------------------------------------------------------------------
        public List<TileDataModel> LoadTiles() {
            return _tileRepository.GetTileEntities();
        }

        public void RemoveTile(TileDataModel tileDataModel) {
            _tileRepository.DeleteTile(tileDataModel);
        }
        ...
        public List<TileImageDataModel> LoadTileImageEntities() {
            return _tileImageRepository.GetTileImageEntities();
        }
