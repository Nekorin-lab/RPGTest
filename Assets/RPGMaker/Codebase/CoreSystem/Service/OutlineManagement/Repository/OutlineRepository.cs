    ...
    public class OutlineRepository
    {
...
#if UNITY_EDITOR
        private const string JsonFilePath = "Assets/RPGMaker/Storage/Outline/";
        private const string JsonFileTranslation = "Assets/RPGMaker/Storage/Outline/outlineTranslation.txt";
#endif
        ...
        public void JsonTranslation() {
            ...
            foreach (string line in System.IO.File.ReadLines(JsonFileTranslation, Encoding.UTF8))
            {
                ...
                lineSplit[0] = JsonFilePath + "/" + lineSplit[0];
