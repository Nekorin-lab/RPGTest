        ...
        void UpdateDisplay() {
            ...
            switch (_talkWindowType)
            {
                ...
                case TalkWindowType.Item:
                    ...
                    ItemDataModel dummy = ItemDataModel.CreateDefault("dummy");
                    dummy.basic.name = EditorLocalize.LocalizeText("WORD_0068");
                    dummy.basic.iconId = "IconSet_176";

                    // 既に表示しているアイテムがあれば削除
                    itemWindow.ClearItemList();

                    // ダミーのアイテム表示
                    var itemShopContent = itemWindow.CreateContent(0, null, dummy);
