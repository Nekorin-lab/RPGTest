    ...
    public class MenuPreview : AbstractPreview
    {
        ...
        public override void InitUi(SceneWindow sceneWindow, bool isChange = false) {
            ...
            _equipStatusValueLuck.GetComponent<Text>().text = TextManager.stLuck;
                //装備項目
            _equipEquipValueWeapon.GetComponent<Text>().text = EditorLocalize.LocalizeText("WORD_0128");
            _equipEquipValueShield.GetComponent<Text>().text = EditorLocalize.LocalizeText("WORD_0343");
            _equipEquipValueHead.GetComponent<Text>().text = EditorLocalize.LocalizeText("WORD_0344");
            _equipEquipValueBody.GetComponent<Text>().text = EditorLocalize.LocalizeText("WORD_0345");
            _equipEquipValueAccessory.GetComponent<Text>().text = EditorLocalize.LocalizeText("WORD_0346");
            //装備メニューに表示されるアクターの更新
            if (actorEnabled)
            {
                CharacterActorDataModel actor = _characterActorDataModels.FindAll(item => item.charaType == (int) ActorTypeEnum.ACTOR)[0];
            ...
            _statusExp.GetComponent<Text>().text = EditorLocalize.LocalizeText("WORD_0285");
            _statusNextExp.GetComponent<Text>().text = EditorLocalize.LocalizeText("WORD_0286");
                //パラメーターステータス
            ...
            _statusParamStatusValueLuck.GetComponent<Text>().text = TextManager.stLuck;
                //パラメーター装備
            _statusParamEquipWeapon.GetComponent<Text>().text = EditorLocalize.LocalizeText("WORD_0128");
            _statusParamEquipShield.GetComponent<Text>().text = EditorLocalize.LocalizeText("WORD_0343");
            _statusParamEquipHead.GetComponent<Text>().text = EditorLocalize.LocalizeText("WORD_0344");
            _statusParamEquipBody.GetComponent<Text>().text = EditorLocalize.LocalizeText("WORD_0345");
            _statusParamEquipAccessory.GetComponent<Text>().text = EditorLocalize.LocalizeText("WORD_0346");
        ...
        public void ImageSettingApply() {
            ...
            param.uiPatternId = 0;
            param.bgSprite =
                UnityEditorWrapper.AssetDatabaseWrapper.LoadAssetAtPath<Sprite>(UI_PATH + "Window/" + _uiSettingDataModel.commonMenus[param.uiPatternId].backgroundImage.image + ".png");
            param.bgImageSprite =
            ...
            //メニューへの適用
            ImageSettingApplyMenu(param);
            //セーブメニューへの適用
            ImageSettingApplySaveMenu(param);
            //バトルメニューへの適用
            ImageSettingApplyBattleMenu(param);
            //タイトルメニューへの適用
            ImageSettingApplyTitleMenu(param);
            //ショップへの適用
            ImageSettingApplyShop(param);
            //ショップアイテムへの適用
            ImageSettingApplyShopItem(param);
            //名前入力への適用
            ImageSettingApplyInputName(param);
            //数値入力への適用
            ImageSettingApplyInputNum(param);
            //アイテム選択への適用
            ImageSettingApplySelectItem(param);
            //メッセージ表示への適用
            ImageSettingApplyMessage(param);
            //選択肢への適用
            ImageSettingApplyInputSelect(param);
        ...
        /// UIパターンの適用 メニュー
        /// </summary>
        private void ImageSettingApplyMenu(UiPatternParameter param) {
            ...
            if (_uiSettingDataModel.commonMenus[param.uiPatternId].backgroundImage.type == 1)
            {
                ...
                backgroundImage.sprite = param.bgImageSprite;
        ...
        /// UIパターンの適用 セーブメニュー
        /// </summary>
        private void ImageSettingApplySaveMenu(UiPatternParameter param) {
        ...
        /// UIパターンの適用 バトルメニュー
        /// </summary>
        private void ImageSettingApplyBattleMenu(UiPatternParameter param) {
        ...
        /// UIパターンの適用 タイトルメニュー
        /// </summary>
        private void ImageSettingApplyTitleMenu(UiPatternParameter param) {
        ...
        /// UIパターンの適用 ショップ
        /// </summary>
        private void ImageSettingApplyShop(UiPatternParameter param) {
        ...
        /// UIパターンの適用 ショップアイテム
        /// </summary>
        private void ImageSettingApplyShopItem(UiPatternParameter param) {
        ...
        /// UIパターンの適用 名前入力
        /// </summary>
        private void ImageSettingApplyInputName(UiPatternParameter param) {
        ...
        /// UIパターンの適用 数値入力
        /// </summary>
        private void ImageSettingApplyInputNum(UiPatternParameter param) {
        ...
        /// UIパターンの適用 アイテム選択
        /// </summary>
        private void ImageSettingApplySelectItem(UiPatternParameter param) {
        ...
        /// UIパターンの適用 メッセージ表示
        /// </summary>
        private void ImageSettingApplyMessage(UiPatternParameter param) {
        ...
        /// UIパターンの適用 選択肢
        /// </summary>
        private void ImageSettingApplyInputSelect(UiPatternParameter param) {
