...
namespace RPGMaker.Codebase.Editor.DatabaseEditor.View.Preview
{
    ...
    public class TitlePreview : AbstractPreview
    {
        ...
        public override void InitUi(SceneWindow sceneWindow, bool isChange = false) {
            ...
            //サイズの制御
            _textNewGame.fontSize = _titleData.startMenu.menuFontSetting.size;
            _textContinue.fontSize = _titleData.startMenu.menuFontSetting.size;
            _textOption.fontSize = _titleData.startMenu.menuFontSetting.size;
