...
namespace RPGMaker.Codebase.Editor.MapEditor.Window.MapEdit
{
    ...
    public class TileGroupEditWindow : EditorWindow
    {
         ...
         * 初期化
         */
        public void Init(TileGroupDataModel tileGroupDataModel, List<TileDataModel> tileEntities) {
        ...
        private void AddCurrentSelectingTileToGroup() {
            ...
            {
                var tiles = _tileInventory.TleEntities.Where(
            ...
            else
            {
                ...
                if (find == false)
                {
                    _tileGroupDataModel.tileDataModels.Add(targetTile);
                    addTile = true;
                }
            }
        ...
        private void RemoveCurrentSelectingTileFromGroup() {
            ...
            var tiles = _tilesInGroup.CurrentSelectingTile.type == TileDataModel.Type.LargeParts
                ? _tileGroupDataModel.tileDataModels.Where(
                    ...
                    .ToArray()
                : new[] {_tilesInGroup.CurrentSelectingTile};

            foreach (var tile in tiles) _tileGroupDataModel.tileDataModels.Remove(tile);
            //_tileGroupDataModel.tileDataModels.Remove(targetTile);
