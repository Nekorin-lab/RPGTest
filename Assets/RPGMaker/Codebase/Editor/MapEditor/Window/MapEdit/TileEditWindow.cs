...
namespace RPGMaker.Codebase.Editor.MapEditor.Window.MapEdit
{
    ...
    public class TileEditWindow : EditorWindow
    {
         ...
         * 初期化
         */
        public void Init(List<TileDataModel> tileEntities, List<TileImageDataModel> tileImageEntities) {
        ...
        public void Refresh(
            ...
            [CanBeNull] List<TileImageDataModel> tileImageEntities = null
        ) {
            ...
            _tileImageInventory.Refresh(_tileImageEntities);
        }
        ...
        private void InitUI() {
            ...
            // タイル画像リスト
            _tileImageInventory = new TileImageInventory(
                _tileImageEntities,
                SelectTileImage
            );
