...
{
    public class OneStepForward : AbstractCommandEditor
    {
        private const string SettingUxml =
            "Assets/RPGMaker/Codebase/Editor/MapEditor/Asset/Uxml/EventCommand/inspector_mapEvent_onestep_forward.uxml";

        public OneStepForward(
        ...
        public override void Invoke() {
            ...
            Toggle moveSkip_toggle =
                RootElement.Query<Toggle>("moveSkip_toggle");
