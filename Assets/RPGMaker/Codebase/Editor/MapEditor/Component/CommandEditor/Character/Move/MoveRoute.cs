...
namespace RPGMaker.Codebase.Editor.MapEditor.Component.CommandEditor.Character.Move
{
    ...
    public class MoveRoute : AbstractCommandEditor
    {
        ...
        public override void Invoke() {
            ...
            //MapEditor.CreateEventPreviewButton(CreatePreviewButton);
            ...
            if (moveKindIndex == 0)
            {
                // EventEditWindow _sceneView = (EventEditWindow) MapEditor.EventEditWindow();
                // _sceneView.LaunchRouteMode(EventEditWindow.BrushKind.EventRoute);
                ...
                {
                    //var position = DatabaseManagementService.LoadSystem().initialParty.startMap.position;
                    //pos[0] = new Vector3Int(position[0], position[1], 0);
                    ...
                    if (eventMap == null) eventMap = eventMaps[0];

                    pos[0] = new Vector3Int(eventMap.x, eventMap.y, 0);
                }
