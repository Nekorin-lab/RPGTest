    ...
    public class PlaceMove : AbstractCommandEditor
    {
        ...
        public override void Invoke() {
            ...
            if (EventCommand.parameters.Count == 0)
            {
                ...
                EventCommand.parameters.Add(MapEntities[0].name);
                EventCommand.parameters.Add(MapEntities[0].id);
                EventCommand.parameters.Add("0");
                EventCommand.parameters.Add("0");
                EventCommand.parameters.Add("0");
                EventCommand.parameters.Add("0");
        ...
        private void UndoLaunchEventEditMode() {
            _xPos.text = "[" + EventCommand.parameters[3] + "]";
            _yPos.text = "[" + EventCommand.parameters[4] + "]";
            MapEditor.LaunchEventEditMode(_mapDataModel, _eventMapDataModel,
                EventDataModel.page);
        }
    }
}