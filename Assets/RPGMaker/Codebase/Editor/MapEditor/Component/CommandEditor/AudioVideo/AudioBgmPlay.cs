...
namespace RPGMaker.Codebase.Editor.MapEditor.Component.CommandEditor.AudioVideo
{
    ...
    ///     「BGMの演奏」のコマンド設定枠の表示物
    /// </summary>
    public class AudioBgmPlay : AbstractCommandEditor
    {
        private const string SettingUxml =
            "Assets/RPGMaker/Codebase/Editor/MapEditor/Asset/Uxml/EventCommand/inspector_mapEvent_audio_bgm_play.uxml";
