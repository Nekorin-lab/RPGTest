...
namespace RPGMaker.Codebase.Editor.MapEditor.Component.CommandEditor.AudioVideo
{
    ...
    ///     「MEの演奏」のコマンド設定枠の表示物
    /// </summary>
    public class AudioMePlay : AbstractCommandEditor
    {
        private const string SettingUxml =
            "Assets/RPGMaker/Codebase/Editor/MapEditor/Asset/Uxml/EventCommand/inspector_mapEvent_audio_me_play.uxml";
        ...
        public override void Invoke() {
            ...
            {
                var path = AssetManageImporter.StartToFile("ogg", PathManager.SOUND_ME);
