...
namespace RPGMaker.Codebase.Editor.MapEditor.Component.Canvas
{
    ...
    public class EventEditCanvas : MapCanvas
    {
        ...
        //private       Color        _startEndColor = new Color(0, 0.7f, 1, 0.5f);
        //private       Color        _journeyColor  = new Color(1, 0.5f, 0, 0.5f);
        ...
        //private bool _isEventDraw = false;
        ...
        protected override void InitUI(bool isSampleMap = false) {
            ...
            //_routeTileMap.transform.localScale = new Vector3(1, 1, 1);
        ...
        public void LaunchDestinationDrawingMode(
            ...
            _targetEventMapPage = _eventMapDataModelEntity?.pages[0]; // FIXME
            _movePosList = null;
        }
        ...
        protected override void OnMouseDrag(MouseMoveEvent e) {
            ...
            else
            {
                ...
                {
                    return;
                    //Brush(GetTilePosOnMousePos(e.mousePosition));
                }
                else
                {
                    // 座標設定時はドラッグは無効。
