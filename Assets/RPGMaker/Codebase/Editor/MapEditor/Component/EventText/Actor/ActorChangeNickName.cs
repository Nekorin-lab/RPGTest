...
{
    /// <summary>
    ///     [アクター設定の変更]のうち、二つ名についての実行内容枠での表示物
    /// </summary>
    public class ActorChangeNickName : AbstractEventText, IEventCommandView
    {
        public override VisualElement Invoke(string indent, EventDataModel.EventCommand eventCommand) {
            ...
            // テキストを代入
            ret =
                $"{indent}{title}{EditorLocalize.LocalizeText("WORD_0337")} : {actorName}, {eventCommand.parameters[4]}";
