    ...
    public class MessageTextOneLine : AbstractEventText, IEventCommandView
    {
        ...
        public override VisualElement Invoke(string indent, EventDataModel.EventCommand eventCommand) {
            ...
            for (var i = 0; i < eventDataModels[eventIndex].eventCommands.Count; i++)
                if (eventDataModels[eventIndex].eventCommands[i] == eventCommand)
                {
                    index = i;
                    break;
                }
            ...
            void UpdateEventMessageTextAndSaveEvent(bool saveOnly) {
                ...
                {
                    EventManagementService.SaveEvent(eventDataModels[index]);
                }
            }
        ...
        private void EditInputText(ImTextField textField) {
            ...
            //    if (lines[i].Length > charNumPerLine)
            //        lines[i] = lines[i].Substring(0, charNumPerLine);
