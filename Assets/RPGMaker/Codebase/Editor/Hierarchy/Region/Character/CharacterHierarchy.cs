...
namespace RPGMaker.Codebase.Editor.Hierarchy.Region.Character
{
    ...
    public class CharacterHierarchy : AbstractHierarchy
    {
        ...
        public void CreateCharacterActorDataModel(CharacterHierarchyView characterHierarchyView) {
            ...
            // インスペクタで表示
            Inspector.Inspector.CharacterView((int) ActorTypeEnum.ACTOR, newDataModel.uuId, characterHierarchyView);
        }
        ...
        public void CreateNpcCharacterActorDataModel(CharacterHierarchyView characterHierarchyView) {
            ...
            // キャラクター領域のみリフレッシュ
            Refresh();
            Hierarchy.InvokeSelectableElementAction(View.LastNpcIndex());
            ...
            // インスペクタで表示
            Inspector.Inspector.CharacterView((int) ActorTypeEnum.NPC, newDataModel.uuId,
                characterHierarchyView);
        }
        ...
        public void PasteActorOrNpcDataModel(
            ...
            newModel.uuId = uuid;
            newModel.basic.name = name + EditorLocalize.LocalizeText("WORD_1462");
            ...
            Refresh();
            Inspector.Inspector.CharacterView(newModel.charaType, newModel.uuId, characterHierarchyView);
            if (newModel.charaType == (int) ActorTypeEnum.ACTOR)
                Hierarchy.InvokeSelectableElementAction(View.LastActorIndex());
            else
                Hierarchy.InvokeSelectableElementAction(View.LastNpcIndex());
        }
        ...
        public void CreateVehicleDataModel() {
            ...
            Refresh();
            OpenVehicleInspector(newModel);
            Hierarchy.InvokeSelectableElementAction(View.LastVehicleIndex());
        }
        ...
        public void PasteVehicleDataModel(VehiclesDataModel vehiclesDataModel) {
            ...
            newModel.id = uuid;
            newModel.name = vehiclesDataModel.DataClone().name + EditorLocalize.LocalizeText("WORD_1462");
            _vehiclesDataModels.Add(newModel);
            databaseManagementService.SaveCharacterVehicles(_vehiclesDataModels);
        ...
        public void CreateClassDataModel() {
            ...
            Refresh();
            Hierarchy.InvokeSelectableElementAction(View.LastClassIndex());
        }
        ...
        public void PasteClassDataModel(ClassDataModel classDataModel) {
            ...
            newModel.id = uuid;
            newModel.basic.name = classDataModel.DataClone().basic.name + EditorLocalize.LocalizeText("WORD_1462");
