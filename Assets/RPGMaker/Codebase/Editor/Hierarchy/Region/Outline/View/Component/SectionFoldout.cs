...
namespace RPGMaker.Codebase.Editor.Hierarchy.Region.Outline.View.Component
{
    public class SectionFoldout : AbstractHierarchyView
    {
        ...
        override protected void InitContentsData() {
            ...
            Add(foldoutWork);
#endif
            SetFoldout("section-foldout" + _sectionDataModel.ID);
            ...
            _mapHierarchyInfo = new OutlineMapHierarchyInfo(GetFoldout("section-foldout" + _sectionDataModel.ID), null, this);
