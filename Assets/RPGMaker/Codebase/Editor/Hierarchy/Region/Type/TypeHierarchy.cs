...
namespace RPGMaker.Codebase.Editor.Hierarchy.Region.Type
{
    ...
    public class TypeHierarchy : AbstractHierarchy
    {
        ...
        public void CreateAttributeType() {
            ...
            Refresh();
            Hierarchy.InvokeSelectableElementAction(View.LastAttributeTypeIndex());
        }
        ...
        public void CreateSkillType() {
            ...
            Refresh();
            Hierarchy.InvokeSelectableElementAction(View.LastSkillTypeIndex());
        }
        ...
        public void CreateWeaponType() {
            ...
            Refresh();
            Hierarchy.InvokeSelectableElementAction(View.LastWeaponTypeIndex());
        }
        ...
        public void CreateArmorType() {
            ...
            Refresh();
            Hierarchy.InvokeSelectableElementAction(View.LastArmorTypeIndex());
        }
