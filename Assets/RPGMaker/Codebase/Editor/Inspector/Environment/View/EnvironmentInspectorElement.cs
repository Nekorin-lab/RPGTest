...
namespace RPGMaker.Codebase.Editor.Inspector.Environment.View
{
    ...
    public class EnvironmentInspectorElement : AbstractInspectorElement
    {
        ...
        override protected void InitializeContents() {
            ...
            {
                if ((Platform) dropdownPopupField.index == Platform.NintendoSwitch)
                {
                    ...
                    commonDropdownPopupField =
                        new PopupFieldBase<string>(sizeList, _systemSettingDataModel.displaySize);
                }

                var check = SelectedPlatform((Platform) dropdownPopupField.index);
                if (!check)
                {
                    //Refresh();
                }
        ...
        private void SaveInputSystem() {
            ...
            var defaultInput = AssetDatabase.LoadAssetAtPath<InputActionAsset>("Assets/RPGMaker/InputSystem/rpgmaker.inputactions");
            ...
            if (_systemSettingDataModel.isController == 0)
            {
                ...
                var eventSystemDefaultPrefab = AssetDatabase.LoadAssetAtPath<GameObject>("Assets/Resources/EventSystemDefault.prefab");
