...
namespace RPGMaker.Codebase.Editor.Inspector.Enemy.View
{
    public class EnemyInspectorElement : AbstractInspectorElement
    {
        ...
        override protected void InitializeContents() {
            ...
            //enemyMagicGuard.isReadOnly = true;
