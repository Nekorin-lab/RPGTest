...
namespace RPGMaker.Codebase.Editor.Inspector.Encounter.View
{
    public class EncounterInspectorElement : AbstractInspectorElement
    {
        ...
        private void SetData() {
...
#if flase // 未使用。
            VisualElement mapIdField = RootContainer.Query<VisualElement>("encounter_map_id_area");
#endif
            ...
            //Foldout encounterEnemyFoldout = RootContainer.Query<Foldout>("encounter_enemy_foldout");
        ...
        private void _SetTroop(int index) {
            ...
            ve3.Add(weightLabel);
            var weight = new IntegerField();
            //weight.label = EditorLocalize.LocalizeText("WORD_0830");
