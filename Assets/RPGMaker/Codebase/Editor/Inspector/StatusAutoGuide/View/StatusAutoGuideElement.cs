...
namespace RPGMaker.Codebase.Editor.Inspector.StatusAutoGuide.View
{
    public class StatusAutoGuideElement : VisualElement
    {
        ...
        private void SetBaseParameter() {
            ...
            //_databaseManagementService.SaveAutoGuide();
        }

        public void SetNowParameter(ClassDataModel.Parameter parameters) {
        }
        ...
        private bool CheckSettingType(ClassDataModel.AutoGuide autoGuide) {
            return autoGuide.attack == 0
                   && autoGuide.defense == 0
                   && autoGuide.magicAttack == 0
                   && autoGuide.magicDefense == 0
                   && autoGuide.speed == 0
                   && autoGuide.luck == 0;
        }
