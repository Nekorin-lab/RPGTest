...
namespace RPGMaker.Codebase.Editor.Inspector.CharacterClass.View
{
    public class CharacterClassInspectorElement : AbstractInspectorElement
    {
        ...
        override protected void InitializeContents() {
            ...
            {
                _actorClass.skillTypes.Add(ClassDataModel.SkillType.CreateDefault());
                SummonSkillType();
                Save(_itemId);
            };
            ...
            void SummonSkillType() {
                ...
                for (var i = 0; i < _actorClass.skillTypes.Count; i++)
                {
                    ...
                    //addSkillTypeArea.Add(skillTypeLabel);
            ...
            //{"categoryId":2,"traitsId":2,"effectId":7,"value":5},{"categoryId":2,"traitsId":2,"effectId":8,"value":5},{"categoryId":2,"traitsId":2,"effectId":9,"value":5}
        ...
        private void _UpdateSceneView() {
            //_element.UpdateClass();
            _ = Editor.Hierarchy.Hierarchy.Refresh(Region.Character);
        }
